...
export function reducer(state, action){
    switch(action.type){
        case actionTypes.SET_ADDRESSES: return {...state, addresses: action.payload};
        case actionTypes.ADD_ADDRESS: return {...state, addresses: [...state.addresses, action.payload]};
        case actionTypes.UPDATE_ADDRESS: {
            const updatedAdresses = state.addresses.map(address => address.id === action.payload.id ? action.payload: address);
