export function Footer(){
    return (
        <footer className="text-white bg-black">
            <div className="flex flex-col md:flex-row justify-center items-center gap-y-8 md:gap-y-0 gap-x-10 md:gap-x-16 py-12">
            ...
            <p className="text-sm font-bold pb-5 pl-5">&copy; 2025 POV<span className="text-red-600">.</span> Store</p>
        </footer>
    );
};
