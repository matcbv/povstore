...
export function ProductForm() {
	...
	return (
		<form
			className="flex flex-col-reverse lg:flex-row items-center gap-y-10 md:gap-y-0 md:gap-x-20 w-full max-w-xl lg:max-w-4xl"
		...
		>
			<div className="h-full flex flex-col justify-end items-center gap-y-5 w-2/3 lg:w-1/2">
				...
				<div className="flex flex-col w-full">
					<label
						htmlFor="image"
						className="py-2 bg-black border-2 rounded-md text-center text-white cursor-pointer"
					>
						Escolher Arquivo
					</label>
					<input
				...
				<input
					...
					className="w-full border-2 border-black rounded-md px-10 py-2 font-bold cursor-pointer"
				/>
			</div>
			<div className="flex flex-col gap-y-8 w-2/3 lg:w-1/2 h-full">
				...
				<div className="flex flex-col">
					...
					<textarea
						...
						className="default-inputs resize-none"
						onChange={handleChange}
					/>
				</div>
				<div className="flex flex-col">
					<label htmlFor="category" className="font-bold text-sm md:text-base">
				...
				<div className="flex flex-col">
					<label htmlFor="price" className="font-bold text-sm md:text-base">
				...
				<div className="flex flex-col">
					<label htmlFor="quantity" className="font-bold text-sm md:text-base">
