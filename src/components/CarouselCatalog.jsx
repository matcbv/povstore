    ...
    return (
        <section className='flex flex-col items-center px-4 md:px-0 bg-[linear-gradient(to_right,_#0000004a,_white,_#0000004a)]'>
            ...
            <div className='flex items-center my-16 md:my-24'>
                <img src="/assets/images/carousel_left_arrow.png" alt="Item anterior" className='hover:cursor-pointer' />
                ...
                <img src="/assets/images/carousel_right_arrow.png" alt="Próximo item" className='hover:cursor-pointer' />
            </div>
        </section>
    );
};
